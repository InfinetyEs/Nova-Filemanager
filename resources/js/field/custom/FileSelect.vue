<template>
    <div class="flex flex-wrap items-stretch w-full mb-2 relative">
        <input :disabled="field.disabled" type="text" class="flex-shrink flex-grow flex-auto leading-normal w-px flex-1 form-control form-input form-input-bordered-l relative"
