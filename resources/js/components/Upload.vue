        ...
        methods: {
            ...
            vsuccess(file, response) {
                if (response == true) {
                    ...
                    this.$toasted.show(this.__('File') + ' ' + file.name + ' ' + this.__('uploaded successfully'), { type: 'success' })
                    this.$emit('refresh', true);
                } else {
                    this.$toasted.show(this.__('Error uploading the file. Check your MaxFilesize or permissions'), { type: 'error' })
                }
		    },
        }
    }
