...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Folder name for kiosks
    |--------------------------------------------------------------------------
     */
    'folder_kiosk_name' => 'Bornes',

    /*
    |--------------------------------------------------------------------------
    | Folder name for catalogues
    |--------------------------------------------------------------------------
     */
    'folder_catalogue_name' => 'Catalogues',

    /*
    |--------------------------------------------------------------------------
    | Folder name for screen saver
    |--------------------------------------------------------------------------
     */
    'folder_screen_saver_name' => 'Ecrans de veille',

    /*
    |--------------------------------------------------------------------------
    | Folder name for shared screen saver
    |--------------------------------------------------------------------------
     */
    'folder_shared_screen_saver_name' => 'DS MediKiosk Defaut',
];
